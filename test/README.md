...
41 assertions against the live tool surface, driven through the real WebMCP API
...
Covers: all nine tools, argument validation on every one (missing, wrong type, out of
...
Last run 2026-09-02: **41 passed, 0 failed.**
